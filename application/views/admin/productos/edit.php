                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/productos/update" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $producto->nombreProducto?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="precion" name="precio" value="<?php echo $producto->valorUnitario?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="categoria" id="categoria" class="form-control">
                                    <?php foreach($categorias as $categoria):?>
                                        <?php if($categoria->id == $producto->idCategoria):?>
                                        <option value="<?php echo $categoria->id?>" selected><?php echo $categoria->nombreCategoria;?></option>
                                    <?php else:?>
